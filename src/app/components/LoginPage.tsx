          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-lg border-2 border-gray-300 px-4 py-3 transition-all hover:bg-gray-50"
              >
                ...
                <span>
                  {language === 'vi' ? 'Dang nhap voi Google' : 'Login with Google'}
                </span>
              </button>
